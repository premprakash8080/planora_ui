...
import { SidebarService } from 'src/app/layout/dashboard/services/sidebar.service';
...
export class LayoutComponent implements OnInit, AfterViewInit {
  ...
  @Input() dashboardSchedulePanelRef: TemplateRef<any>;
  ...
  @ViewChild('dashboardSchedulePanel', { static: true }) dashboardSchedulePanel: MatSidenav;
  ...
  ngOnInit() {
    ...
    // this.layoutService.dashboardSchedulePanelOpen$.pipe(
    //   untilDestroyed(this)
    // ).subscribe(open => open ? this.dashboardSchedulePanel.open() : this.dashboardSchedulePanel.close());
