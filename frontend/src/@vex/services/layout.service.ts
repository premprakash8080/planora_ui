...
export class LayoutService {
  ...
  private _dashboardSchedulePanelOpenSubject = new BehaviorSubject<boolean>(false);
  dashboardSchedulePanelOpen$ = this._dashboardSchedulePanelOpenSubject.asObservable();
  ...
  openDashboardSchedulePanel() {
    this._dashboardSchedulePanelOpenSubject.next(true);
  }

  closeDashboardSchedulePanel() {
    this._dashboardSchedulePanelOpenSubject.next(false);
  }
